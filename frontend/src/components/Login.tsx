    ...
    <div className="relative flex items-center justify-center min-h-screen">
      <div className="max-w-md p-6 rounded-lg">
        ...
        <form
          ...
          <button
            type="submit"
            className="w-full px-4 py-3 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-vezmir-hover focus:ring-opacity-50"
          >
            {locale('auth_login')}
          </button>
        </form>
        ...
        <p className="my-4 text-center text-sm font-light text-gray-700 text-white">
          ...
          <Link to="/register" className="p-1 text-[vezmir-clear]">
          {/* <a href="https://docs.google.com/forms/d/e/1FAIpQLSfzyV-GXIeiBWBkDuV2rNGQCfue6wJPSXAIFP2rx_w78N8fWA/viewform" className="p-1 text-[vezmir-clear]"> */}
          {locale('auth_sign_up')}
          </Link>
        </p>
      </div>
